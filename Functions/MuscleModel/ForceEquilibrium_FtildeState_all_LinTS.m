...
% This version of the function returns many outputs that are needed when
% estimating the metabolic energy
function [err, FT, Fce, Fiso, vMmax, massM, vM , lMo,FMltilde, lMtilde, lTtilde] = ForceEquilibrium_FtildeState_all_LinTS(a,fse,dfse,lMT,vMT,params,Fvparam,Fpparam,Faparam,tension,Atendonsc)
